...
int main(void)
{
    ...
    TB0CTL = TASSEL_2 + MC_0;           // Timer_A Control Register - SMCLK high frequency clock, timer stopped
    ...
    __interrupt void Interrupt_1(void)
    {
        ...
        TB0CTL = TASSEL_2 + MC_1;           // Timer_A Control Register - SMCLK high frequency clock, Up
    }
